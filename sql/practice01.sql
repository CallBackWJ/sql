...
select count(distinct emp_no) from salaries where to_date = '9999-01-01';
...
select count(distinct emp_no) from salaries where to_date = '9999-01-01' and salary>120000 ;
